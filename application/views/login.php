...
<html lang="en">
    ...
    <body>
        <p class="lead text-center">C.O.D.E <br /> Controle de Ocorrências e Desempenho Escolar</p>
        <div class="container">
...
<!--                <label class="checkbox ">
        ...
        <p class="text-center">
            <small>Caso não possua um login, contate o administrador(a) do sistema</small>
        </p>
        <!-- /container -->
